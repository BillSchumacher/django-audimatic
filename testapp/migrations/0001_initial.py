    ...
    operations = [
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash="ae8638ede3eeabe979e5e9f0c6a22a11874cc9dd",
                    operation="INSERT",
                    pgid="pgtrigger_track_history_create_54cee",
                    table="testapp_customuser",
                    when="AFTER",
                ),
            ),
        ),
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func="\n    INSERT INTO testapp_useraudittrail(before, after)\n        SELECT hstore(old), hstore(new);\n    RETURN new;\n",
                    hash="741990c94a8594b73f00ca2f222b6953a7064671",
                    operation="UPDATE",
                    pgid="pgtrigger_track_history_update_f7583",
                    table="testapp_customuser",
                    when="AFTER",
                ),
            ),
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func="\n    INSERT INTO testapp_useraudittrail(before, after)\n        SELECT hstore(old), hstore(new);\n    RETURN new;\n",
                    hash="478b6e2629b988ab0743fe725acdc395d923b2dd",
                    operation="DELETE",
                    pgid="pgtrigger_track_history_delete_5ef81",
                    table="testapp_customuser",
                    when="AFTER",
                ),
            ),
